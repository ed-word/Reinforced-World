...
PATH_TO_TEST_IMAGES_DIR = '/home/edward/Workspace/Angel/Pedestrian-Detection/Data/Images'
...
for image_path in TEST_IMAGE_PATHS:
	...
	for c,s in zip(output_dict['detection_classes'],output_dict['detection_scores']):
		if (s < 0.5):
			break
		else:
